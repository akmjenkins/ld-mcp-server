...
import { ClientOptions } from 'test-language';
...
export { ClientOptions } from 'test-language';
export { endpoints } from './tools';

// Create server instance
export const server = new McpServer(
  {
    name: 'test_language_api',
...
export function initMcpServer(params: {
  ...
  const client = new TestLanguage(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
