...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/api/v2/engineering-insights/charts/releases/frequency',
...
export const handler = async (client: TestLanguage, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.api.v2.engineeringInsights.charts.releases.retrieveFrequency(body));
};
