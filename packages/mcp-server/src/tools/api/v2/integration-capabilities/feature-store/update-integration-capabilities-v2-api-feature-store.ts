...
export const tool: Tool = {
  name: 'update_integration_capabilities_v2_api_feature_store',
  description:
...
export const handler = async (client: TestLanguage, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.api.v2.integrationCapabilities.featureStore.update(id, body));
};
