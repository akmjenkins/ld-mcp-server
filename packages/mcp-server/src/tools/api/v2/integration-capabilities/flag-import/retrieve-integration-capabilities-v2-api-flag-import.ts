...
export const handler = async (client: TestLanguage, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(
      args,
      await client.api.v2.integrationCapabilities.flagImport.retrieve(integrationId, body),
    ),
  );
};
