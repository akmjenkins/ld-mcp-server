...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/api/v2/usage/experimentation-units',
  operationId: 'getExperimentationUnitsUsage',
};

export const tool: Tool = {
  name: 'retrieve_experimentation_units_v2_api_usage',
  description:
...
export const handler = async (client: TestLanguage, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.api.v2.usage.retrieveExperimentationUnits(body));
};
