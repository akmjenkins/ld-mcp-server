...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/api/v2/projects/{projectKey}/environments/{environmentKey}/contexts/search',
...
export const handler = async (client: TestLanguage, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.api.v2.projects.environments.contexts.search(environmentKey, body));
};
