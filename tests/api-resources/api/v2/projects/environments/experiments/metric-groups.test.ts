...
describe('resource metricGroups', () => {
  ...
  test.skip('retrieveResults: only required params', async () => {
    const responsePromise = client.api.v2.projects.environments.experiments.metricGroups.retrieveResults(
      'metricGroupKey',
  ...
  test.skip('retrieveResults: required and optional params', async () => {
    const response = await client.api.v2.projects.environments.experiments.metricGroups.retrieveResults(
      'metricGroupKey',
      {
