...
The REST API documentation can be found on [support.launchdarkly.com](https://support.launchdarkly.com). The full API of this library can be found in [api.md](api.md).
...
1. Via the `TEST_LANGUAGE_LOG` environment variable
...
const client = new TestLanguage({ fetch });
```
